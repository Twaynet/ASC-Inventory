...
interface DayViewProps {
  ...
  timeoutDebriefEnabled: boolean;
}

export function DayView({ selectedDate, token, user, timeoutDebriefEnabled }: DayViewProps) {
  const router = useRouter();
  ...
  const handleScan = useCallback(
    ...
    [token, selectedDeviceId, addNotification, loadData]
  );
